                                ...
                                <form className="space-y-4 md:space-y-6" onSubmit={handleLogin}>
                                    ...
                                    <div className="max-w-sm">
                                        ...
                                        <div className="relative">
                                            ...
                                            >
                                                <svg
                                                        className="flex-shrink-0 w-3.5 h-3.5 text-gray-900 sm:text-sm rounded-md focus:ring-primary-600 focus:border-primary-600 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                        width={24}
                                                        height={24}
                                                        viewBox="0 0 24 24"
                                                        fill="none"
